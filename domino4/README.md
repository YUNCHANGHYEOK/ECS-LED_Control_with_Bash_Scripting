...
Bash 스크립트(`LED_Domino.sh`)를 작성하여 Raspberry Pi의 GPIO 핀을 통해 LED를 제어합니다.
...
|----------|--------------------------|
| 0        | GPIO 18 켜짐              |
| 1        | GPIO 18 꺼짐, GPIO 23 켜짐  |
| 2        | GPIO 23 꺼짐, GPIO 24 켜짐  |
| 3        | GPIO 24 꺼짐, GPIO 25 켜짐  |
| 4 이후   | 반복 (다시 GPIO 18 켜짐)   |
